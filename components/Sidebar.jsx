...
const Sidebar = () => {
    ...
    return (
        <div className={sidebarStyles.sidebar}>
            {/*Banner*/}
            <div class={sidebarStyles.banner}>
                <Image
                    className={sidebarStyles.bannerImage}
                    alt="profile banner"
                    src="/user_content/p_banners/pinkdunes.png"
                    layout="fill"
                    objectFit="cover"
                />
            </div>
            {/*User Profile*/}
            <div class={sidebarStyles.profileContainer}>
                <div class={sidebarStyles.p_cvlayoutzero}>
                ...
                <p class={sidebarStyles.p_description}>{user.Description}</p>
